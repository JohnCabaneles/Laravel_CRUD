...
class ProductController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        $request->validate([ // verification in database
            'name' => 'required',
        ...
        request()->image->move(public_path('images'), $file_name); // when you get image in the input it will save it to the $file_name variable
